...
func setCurveParams[Point NistECPoint[Point]](c *Curve[Point], prime, b string, newPoint func() Point) {
...
func setMapping[Point NistECPoint[Point]](c *Curve[Point], hash crypto.Hash, z string, secLength int) {
	c.mapping.hash = hash
...
func preComputeMap[Point NistECPoint[Point]](c *Curve[Point]) {
...
//func (c Curve[any]) identity() *Element[any] {
//	return &Point{
//		curve: &c,
//		x:     big.NewInt(0),
//		y:     big.NewInt(0),
